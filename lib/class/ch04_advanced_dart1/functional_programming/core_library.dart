main() {
  ...
  // Result : 과일들:사과,오렌지,수박,체리

    ///정규표현식
  final findNumberRegExp = RegExp(r'\d+'); //숫자
  ...
  print(uri.scheme); // result : https
  print(uri.host); // result : api.dart.dev
  print(uri.path); // ?가 나오기 전까지의 영역
